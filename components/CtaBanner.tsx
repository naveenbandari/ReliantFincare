          ...
          <div className="relative z-10 px-8 py-16 md:py-20 md:px-16">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
              ...
              <div className="max-w-2xl text-center lg:text-left">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 text-white/90 text-xs font-semibold uppercase tracking-widest mb-5">
              ...
              <div className="flex flex-col sm:flex-row lg:flex-col gap-4 flex-shrink-0 w-full sm:w-auto lg:w-auto">
                <Link
                  href="/apply"
                  className="inline-flex justify-center items-center gap-2 bg-white text-brand-primary px-8 py-4 rounded-xl font-bold text-base hover:bg-slate-100 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-0.5 whitespace-nowrap"
                >
                  Apply Now <ArrowRight size={19} />
                </Link>
                <a
                  href="tel:+917702523998"
                  className="inline-flex justify-center items-center gap-2 bg-white/10 border-2 border-white/30 text-white px-8 py-4 rounded-xl font-bold text-base hover:bg-white/20 transition-all whitespace-nowrap backdrop-blur-sm"
                >
                  <Phone size={18} />
                  Talk to Expert
                </a>
